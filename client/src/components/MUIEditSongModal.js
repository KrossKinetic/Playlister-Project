        ...
        >
            <Box sx={style1}>
                <div id="edit-song-modal" data-animation="slideInOutLeft">
                    ...
                    <Button
                        sx={{ color: "#8932CC", backgroundColor: "#CBC3E3", fontSize: 13, fontWeight: 'bold', border: 2, borderRadius: 2, p: "5px", mt: "20px" }} variant="outlined"
                        id="edit-song-confirm-button" onClick={handleConfirmEditSong}>Confirm</Button>
                    <Button
                        sx={{ opacity: 0.80, color: "#8932CC", backgroundColor: "#CBC3E3", fontSize: 13, fontWeight: 'bold', border: 2, borderRadius: 2, p: "5px", mt: "20px", ml: "197px" }} variant="outlined"
